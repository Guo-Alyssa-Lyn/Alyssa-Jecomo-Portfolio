...
function App() {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      slug: "https://technologywebdev15.substack.com/p/website-development-roadmap-learning",
    },
    {
      image: "/assets/blogs/blog-05.png",
      title: "The Rise of Artificial Intelligence (AI)",
      excerpt: "AI in the Workforce: Impact on Jobs and Communities",
      date: "May 11, 2025",
      readTime: "5 min read",
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-white">
        ...
        <div className="container mx-auto px-8">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
            <div className="flex-1 text-center lg:text-left">
              <h2 className="text-2xl mb-4 text-emerald-500 font-medium">
                Hello There!
              </h2>
              <h1 className="text-5xl lg:text-7xl font-bold mb-6">
                I am Web<span className="text-emerald-500">{typedText}</span>
                <span className="text-emerald-500 animate-pulse">|</span>
              </h1>
              <p className="text-xl text-gray-400 mb-12 max-w-2xl">
                Passionate about crafting exceptional digital experiences that
                captivate audiences, enhance engagement, and drive success
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            ...
            <div>
              <div className="space-y-4 pt-0">
                <div>
                  <h2 className="text-4xl lg:text-5xl text-emerald-500 font-bold mb-20">
                    About Me
                  </h2>
      ...
      <section id="services" className="py-32">
        <div className="container mx-auto px-8">
          <h2 className="text-4xl lg:text-5xl text-emerald-500 font-bold mb-24 text-center">
            My Services
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <ServiceCard
      ...
      <section id="blog" className="py-32">
        <div className="container mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg max-w-3xl mx-auto">
              Explore my latest thoughts, tutorials, and insights on web
              development, programming, and tech industry trends.
            </p>
          </div>
      ...
      <section id="announcements" className="py-32">
        <div className="container mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg max-w-3xl mx-auto">
              Stay updated with the recent news and updates about my projects
...
function ServiceCard({ icon, title, description }: ServiceCardProps) {
  return (
    <div
      className="group bg-[#1f1f1f] p-8 rounded-2xl hover:bg-[#252525] transition-all duration-300
...
function ProjectCard({
  ...
  return (
    <div
      className="group bg-[#1f1f1f] rounded-2xl overflow-hidden hover:shadow-lg 
      hover:shadow-emerald-500/10 transition-all duration-300"
    >
  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        <p className="text-gray-400 text-sm mb-6">{excerpt}</p>
        <a
          href={
            slug
          } /* Use the slug directly as it already contains the full URL */
...
function ContactInfo({ icon, title, content }: ContactInfoProps) {
  return (
    <div
      className="flex items-start space-x-4 p-6 bg-[#252525] rounded-xl hover:bg-[#2a2a2a] 
